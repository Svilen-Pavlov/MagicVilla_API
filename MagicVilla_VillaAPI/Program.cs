...
var key = builder.Configuration.GetValue<string>("ApiSettings:Secret"); // var to store appJson config
...
{
    //options.ReturnHttpNotAcceptable = true;    // enables response of 406 codes when the type is 
})
    .AddNewtonsoftJson()
